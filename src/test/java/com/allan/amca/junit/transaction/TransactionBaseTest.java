...
import main.com.allan.amca.transaction.TransactionFactory;
...
class TransactionBaseTest extends TransactionTest {
    ...
    void performTransaction() {
        ...
        assertTrue(withdraw.performTransaction(4500123410000000L, BigDecimal.valueOf(100.0)));
        assertTrue(deposit.performTransaction(4500123410000000L, BigDecimal.valueOf(100.0)));

        assertTrue(deposit2.performTransaction(4500123410000004L, BigDecimal.valueOf(2143.0)));
        assertTrue(withdraw2.performTransaction(4500123410000004L, BigDecimal.valueOf(2143.0)));
    }
}